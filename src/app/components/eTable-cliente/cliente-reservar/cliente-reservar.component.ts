...
export class ClienteReservarComponent implements OnInit {
  ...
  constructor(
    ...
    private service: ReservacionService,
  ...
  public register() {
    ...
    if (!this.empty) {
      ...
      Swal.fire("Campos Incompletos", this.successText + "", "question");
    }
  }
